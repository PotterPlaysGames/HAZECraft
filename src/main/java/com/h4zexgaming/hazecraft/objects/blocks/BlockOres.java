...
import com.h4zexgaming.hazecraft.objects.blocks.item.ItemBlockVariants;
import com.h4zexgaming.hazecraft.util.Interfaces.IHasModel;
import com.h4zexgaming.hazecraft.util.Interfaces.IMetaName;
import com.h4zexgaming.hazecraft.util.handlers.EnumHandler;
...
public class BlockOres extends Block implements IHasModel, IMetaName
{
	...
	public BlockOres(String name, String dimension)
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.ENDERIAN));
